<head>
    ...
    <link href="http://kolodiana.pl/templates/kolodiana9/favicon.ico" rel="shortcut icon" type="image/vnd.microsoft.icon" />
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/css/new_main.css')}}" media="screen" />
