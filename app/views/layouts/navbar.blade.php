                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                       {{--  <li class="sidebar-search">
                        ...
                        <li>
                            <a href="panels-wells.html"><i class="fa fa-dashboard fa-fw"></i> Panels and Wells</a>
                        </li>   
               
                        <li>
                            <a href="#"><i class="fa fa-dashboard fa-fw"></i> Second Level Item</a>
                        </li>   
               
                        <li>
                            <a href="login.html"><i class="fa fa-dashboard fa-fw"></i> Login Page</a>
                        </li>   
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
